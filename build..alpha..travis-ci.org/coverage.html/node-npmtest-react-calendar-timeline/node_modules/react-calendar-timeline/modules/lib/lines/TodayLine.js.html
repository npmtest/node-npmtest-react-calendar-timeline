...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-calendar-timeline/node_modules/react-calendar-timeline/modules/lib/lines/TodayLine.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-calendar-timeline/node_modules/react-calendar-timeline/modules/lib/lines/TodayLine.js</span></h1>
    <h2>
        
        Statements: <span class="metric">65.38% <small>(34 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-calendar-timeline/node_modules/react-calendar-timeline/modules/lib/lines/</a> &#187; TodayLine.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function TodayLine() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, TodayLine);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (TodayLine.__proto__ || Object.getPrototypeOf(TodayLine)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (currentTime &gt; this.props.canvasTimeStart &amp;&amp; currentTime &lt; this.props.canvasTimeEnd) {</span>
<span class="cstat-no" title="statement not covered" >        var ratio = this.props.canvasWidth / (this.props.canvasTimeEnd - this.props.canvasTimeStart);</span>
<span class="cstat-no" title="statement not covered" >        var left = Math.round((currentTime - this.props.canvasTimeStart) * ratio);</span>
<span class="cstat-no" title="statement not covered" >        var top = this.props.headerHeight;</span>
<span class="cstat-no" title="statement not covered" >        var height = this.props.height - this.props.headerHeight;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return _react2.default.createElement('div', { className: 'rct-today', style: styles });</span>
      } else {
<span class="cstat-no" title="statement not covered" >        return _react2.default.createElement('div', null);</span>
      }
    }
  }]);
&nbsp;
