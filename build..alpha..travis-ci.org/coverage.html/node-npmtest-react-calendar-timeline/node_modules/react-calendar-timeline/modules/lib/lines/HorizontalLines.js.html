...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-calendar-timeline/node_modules/react-calendar-timeline/modules/lib/lines/HorizontalLines.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-calendar-timeline/node_modules/react-calendar-timeline/modules/lib/lines/HorizontalLines.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-calendar-timeline/node_modules/react-calendar-timeline/modules/lib/lines/</a> &#187; HorizontalLines.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function HorizontalLines() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, HorizontalLines);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (HorizontalLines.__proto__ || Object.getPrototypeOf(HorizontalLines)).apply(this, arguments));</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return !(nextProps.canvasWidth === this.props.canvasWidth &amp;&amp; nextProps.lineHeight === this.props.lineHeight &amp;&amp; nextProps.lineCount === this.props.lineCount &amp;&amp; nextProps.groupHeights === this.props.groupHeights);</span>
    }
  }, {
    key: 'render',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var totalHeight = headerHeight;</span>
<span class="cstat-no" title="statement not covered" >      for (var i = 0; i &lt; lineCount; i++) {</span>
<span class="cstat-no" title="statement not covered" >        lines.push(_react2.default.createElement('div', { key: 'horizontal-line-' + i,</span>
...
<span class="cstat-no" title="statement not covered" >        totalHeight += groupHeights[i];</span>
      }
&nbsp;
