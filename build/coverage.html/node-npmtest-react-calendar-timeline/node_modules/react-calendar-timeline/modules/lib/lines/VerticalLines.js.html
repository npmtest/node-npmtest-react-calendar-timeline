...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-calendar-timeline/node_modules/react-calendar-timeline/modules/lib/lines/VerticalLines.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-react-calendar-timeline">npmtest-react-calendar-timeline (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-react-calendar-timeline/node_modules/react-calendar-timeline/modules/lib/lines/VerticalLines.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">50% <small>(17 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-calendar-timeline/node_modules/react-calendar-timeline/modules/lib/lines/</a> &#187; VerticalLines.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function VerticalLines() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, VerticalLines);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (VerticalLines.__proto__ || Object.getPrototypeOf(VerticalLines)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var ratio = canvasWidth / (canvasTimeEnd - canvasTimeStart);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var lines = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      (0, _utils.iterateTimes)(canvasTimeStart, canvasTimeEnd, minUnit, timeSteps, <span class="fstat-no" title="function not covered" >function (time, nextTime) {</span></span>
<span class="cstat-no" title="statement not covered" >        var left = Math.round((time.valueOf() - canvasTimeStart) * ratio, -2);</span>
<span class="cstat-no" title="statement not covered" >        var minUnitValue = time.get(minUnit === 'day' ? 'date' : minUnit);</span>
<span class="cstat-no" title="statement not covered" >        var firstOfType = minUnitValue === (minUnit === 'day' ? 1 : 0);</span>
<span class="cstat-no" title="statement not covered" >        var lineWidth = firstOfType ? 2 : 1;</span>
<span class="cstat-no" title="statement not covered" >        var labelWidth = Math.ceil((nextTime.valueOf() - time.valueOf()) * ratio) - lineWidth;</span>
<span class="cstat-no" title="statement not covered" >        var leftPush = _this2.props.fixedHeader === 'fixed' &amp;&amp; firstOfType ? -1 : 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var classNames = 'rct-vl' + (firstOfType ? ' rct-vl-first' : '') + (minUnit === 'day' || minUnit === 'hour' || minUnit === 'minute' ? ' rct-day-' + time.day() : '');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        lines.push(_react2.default.createElement('div', { key: 'line-' + time.valueOf(),</span>
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Sat Apr 22 2017 04:02:22 GMT+0000 (UTC)</div>
</div>
</body>
</html>
